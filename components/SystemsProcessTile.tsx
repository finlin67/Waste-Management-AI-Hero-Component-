...
export default function SystemsProcessTile() {
    ...
    <div className="relative w-full max-w-[600px] aspect-square bg-[#020617] rounded-xl overflow-hidden border border-[#1e293b] shadow-2xl flex flex-col items-center justify-between p-8 font-display select-none">
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none z-0">
         <svg className="w-full h-full" viewBox="0 0 600 600">
          ...
          {/* Starts near (110, 120) ends at Top of Node (300, 230) */}
          <motion.path 
          ...
          {/* Starts near (490, 120) ends at Top of Node (300, 230) */}
          <motion.path 
          ...
          {/* Starts Bottom of Node (300, 370) ends near (110, 480) */}
          <motion.path 
          ...
          {/* Starts Bottom of Node (300, 370) ends near (490, 480) */}
          <motion.path 
